...
export class BookingService {
    ...
    addBooking(placeId: string,
        ...
        const newBooking = new Booking(
            ...
            dateFrom,
            dateTo);
        return this.httpClient.post<{ name: string }>('https://ionic-angular-test-cource.firebaseio.com/bookings.json', {
            ...newBooking,
            id: null
        })
    ...
    fetchBookings() {
        return this.httpClient.get<{ [key: string]: BookingData }>(
            `https://ionic-angular-test-cource.firebaseio.com/bookings.json?orderBy="userId"&equalTo="${this.authService.userId}"`
